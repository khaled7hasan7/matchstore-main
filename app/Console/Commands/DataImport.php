...
class DataImport extends Command
{
    ...
    protected function createCategoriesAndProducts()
    {
        ...
        StoreSetting::insert([
            ...
            ['key' => 'meta_title', 'value' => 'Welcome to MatchStore - Your Laravel eCommerce Journey Begins!'],
            ['key' => 'meta_description', 'value' => 'Welcome to MatchStore! You have successfully installed the ultimate Laravel eCommerce boilerplate. Set up your store, configure settings, and start selling with a powerful multi-vendor, multilingual platform.'],
