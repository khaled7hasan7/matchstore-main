...
class MatchStore extends Command
{
     ...
     * @var string
     */
    protected $signature = 'install:matchstore {--locale= : Set the application locale} {--with-import : Import default data}';
     ...
     * @var string
     */
    protected $description = 'Install MatchStore Ecommerce Built with Laravel by Match Systems.';
    ...
    public function handle()
    {
        ...
        $this->info('MatchStore installation completed successfully.');
