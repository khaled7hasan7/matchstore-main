            ...
            foreach ($products as $item) {
                ...
                foreach ($languages as $lang) {
                    ...
                    $translatedDescription = match ($lang->code) {
                        'ar' => match ($item['name']) {
                            'Cool T-Shirt' => 'تي شيرت عصري متوفر بعدة أحجام وألوان.',
                            'Sport Shoes' => 'أحذية رياضية مريحة للاستخدام اليومي.',
                            'Wireless Headphones' => 'سماعات لاسلكية مع ميزة إلغاء الضوضاء وبطارية طويلة الأمد.',
                            'Travel Backpack' => 'حقيبة ظهر متينة للسفر والأنشطة الخارجية.',
                ...
                // Only create images and variants if product was just created (doesn't already exist)
                if (!$product->wasRecentlyCreated && $product->variants()->count() > 0) {
                    // Product already exists with variants, skip image and variant creation
                    continue;
                }
