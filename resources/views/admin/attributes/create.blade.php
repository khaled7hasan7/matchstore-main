...
<div class="container-fluid">
    ...
    <div class="page-header">
        <div class="d-flex justify-content-between align-items-center">
            <div>
                <h2 class="page-title">{{ __('cms.attributes.title_create') }}</h2>
                <p class="page-subtitle">{{ __('cms.attributes.create_subtitle') ?? 'Create a new product attribute with values' }}</p>
            </div>
            <div>
            ...
            <form action="{{ route('admin.attributes.store') }}" method="POST">
                ...
                <div class="d-flex gap-2">
                    <button type="submit" class="btn btn-primary">
                        <i class="bi bi-check-circle me-2"></i>{{ __('cms.attributes.save_attribute') }}
                    </button>
