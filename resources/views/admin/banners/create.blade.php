...
<div class="container-fluid">
    ...
    <div class="page-header mb-4">
        <div class="d-flex justify-content-between align-items-center">
            <div>
                <h2 class="page-title">{{ __('cms.banners.create_banner') }}</h2>
                <p class="page-subtitle">{{ __('cms.banners.create_subtitle') ?? 'Add a new promotional banner' }}</p>
            </div>
            <div>
                ...
                <div class="tab-content mt-3">
                    @foreach($languages as $language)
                        <div class="tab-pane fade show {{ old('active_tab', $languages->first()->code) === $language->code ? 'active' : '' }}" id="{{ $language->code }}">
                            ...
                            {{-- Description --}}
                            <div class="mb-3">
                                <label class="form-label">{{ __('cms.banners.description') }} ({{ $language->code }})</label>
