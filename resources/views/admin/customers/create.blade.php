...
<div class="container-fluid">
    ...
    <div class="page-header">
        <div class="d-flex justify-content-between align-items-center">
            <div>
                <h2 class="page-title">{{ __('cms.customers.create_title') }}</h2>
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-6 mb-3">
                        <label for="password" class="form-label">
                            {{ __('cms.customers.password') }} <span class="text-danger">*</span>
                        </label>
                        ...
                        <small class="text-muted">{{ __('cms.vendors.min_8_chars') }}</small>
                    </div>
                </div>
