...
<div class="container-fluid">
    ...
    <div class="page-header mb-4">
        <div class="d-flex justify-content-between align-items-center">
            <div>
                <h2 class="page-title">{{ __('cms.promo_cards.create_promo_card') }}</h2>
                <p class="page-subtitle">{{ __('cms.promo_cards.create_subtitle') }}</p>
            </div>
            <div>
    ...
    <div class="card">
        <div class="card-body">
            <form action="{{ route('admin.promo-cards.store') }}" method="POST">
                @csrf
                ...
                <div class="mb-4">
                    ...
                    <select name="size" id="size" class="form-select @error('size') is-invalid @enderror" required>
                        <option value="large" {{ old('size') === 'large' ? 'selected' : '' }}>{{ __('cms.promo_cards.size_large') }}</option>
                        <option value="small" {{ old('size') === 'small' ? 'selected' : '' }}>{{ __('cms.promo_cards.size_small') }}</option>
                    </select>
                ...
                <div class="mb-4">
                    ...
                    <select name="status" id="status" class="form-select @error('status') is-invalid @enderror" required>
                        <option value="1" {{ old('status', '1') === '1' ? 'selected' : '' }}>{{ __('cms.promo_cards.active') }}</option>
                        <option value="0" {{ old('status') === '0' ? 'selected' : '' }}>{{ __('cms.promo_cards.inactive') }}</option>
                    </select>
                        ...
                        <div class="tab-pane fade show {{ $loop->first ? 'active' : '' }}" id="{{ $language->code }}">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text"
                                       ...
                                       value="{{ old('languages.' . $language->code . '.badge_text') }}"
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text"
                                       ...
                                       value="{{ old('languages.' . $language->code . '.button_text') }}"
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text"
                                       ...
                                       value="{{ old('languages.' . $language->code . '.button_url') }}"
                                       placeholder="/shop">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="url"
                                       ...
                                       value="{{ old('languages.' . $language->code . '.image_url') }}"
                ...
                <div class="mt-4 d-flex gap-2">
                    <button type="submit" class="btn btn-primary">
                        <i class="bi bi-check-circle me-2"></i>{{ __('cms.promo_cards.save') }}
                    </button>
                    <a href="{{ route('admin.promo-cards.index') }}" class="btn btn-secondary">
