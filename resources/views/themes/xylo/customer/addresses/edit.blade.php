...
<div class="container py-5">
    <div class="row">
        <div class="col-lg-8 mx-auto">
            ...
            {{-- Page Header --}}
            <div class="mb-4">
                <h2 class="fw-bold">{{ __('store.addresses.edit_address') }}</h2>
                <p class="text-muted">{{ __('store.addresses.edit_subtitle') }}</p>
            </div>
                    ...
                    <form action="{{ route('customer.addresses.update', $address->id) }}" method="POST" id="addressForm">
                        ...
                        <div class="mb-4">
                            ...
                            <textarea name="additional_info"
                                      ...
                                      placeholder="{{ __('store.addresses.additional_info_placeholder') }}">{{ old('additional_info', $address->additional_info) }}</textarea>
                        ...
                        <div class="d-flex gap-3">
                            <button type="submit" class="btn btn-dark btn-lg flex-fill">
                                <i class="fas fa-save me-2"></i>{{ __('store.addresses.update_address') }}
                            </button>
...
<div class="mobile-only">
    ...
    <div class="mobile-address-form-header">
        ...
        <h1>{{ __('store.addresses.edit_address') }}</h1>
    </div>

    {{-- Mobile Form Content --}}
    <div class="mobile-address-form-content">
        <div class="mobile-form-card">
            <form action="{{ route('customer.addresses.update', $address->id) }}" method="POST" id="mobileEditAddressForm">
                @csrf
                @method('PUT')
                ...
                <div class="mobile-form-actions">
                    ...
                    <button type="submit" class="mobile-form-submit">
                        ...
                        {{ __('store.addresses.update_address') }}
                    </button>
                </div>
            </form>
        </div>
